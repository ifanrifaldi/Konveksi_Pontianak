...
<div class="services">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="service-item">
                    <img src="<?php echo e(url ('public/template')); ?>/assets/images/produk/kemeja2.jpeg" alt="">
                    <div class="down-content">
                        <h4>Kemeja PDL</h4>
                        <!-- <div style="margin-bottom:10px;">
                            <span>from <sup>$</sup>120 per weekend</span>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="left-image">
                        <img src="<?php echo e(url ('public/template')); ?>/assets/images/about-1-570x350.jpg" class="img-fluid" alt="">
                    </div>
                </div>
        ...
        <div class="row" id="tabs">
            ...
            <div class="col-md-8">
                <section class='tabs-content'>
                    ...
                    <article id='tabs-3'>
                        <img src="<?php echo e(url ('public/template')); ?>/assets/images/blog-image-3-940x460.jpg" alt="">
...
<?php echo $__env->make('template.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\konveksipontianak\system\resources\views/frontview/beranda.blade.php ENDPATH**/ ?>