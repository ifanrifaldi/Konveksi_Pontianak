...
<?php $__env->startSection('title', 'Bisnis Kami'); ?>
                    ...
                    <div class="row">
                        <div class="col-md-6 align-self-center">
                            <div class="right-content">
                                ...
                                <h2><em>PERDAGANGAN</em></h2>
                                <p>Perdagangan (trading)
                                    hasil pertanian, perkebunan, perikanan, peternakan dan Limbah hasil olahan sawit
                        ...
                        <div class="col-md-6">
                            <div class="left-image">
                                <img src="<?php echo e(url ('public/template')); ?>/assets/images/about-1-570x350.jpg" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="more-info-content">
                    <div class="row">
                        <div class="col-md-6 align-self-center">
                            <div class="right-content">
                                <!-- <span>Lorem ipsum dolor sit amet</span> -->
                                <h2><em>BUDIDAYA TANAMAN</em></h2>
                                <p>Budidaya
                                    Tanaman perkebunan sawit, tanaman pangan dan hortikultura
...
<?php echo $__env->make('template.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\kpm\system\resources\views/frontview/bisnis.blade.php ENDPATH**/ ?>